        ...
        <p class="alert alert-primary" style="margin-top: 2.5%;" role="alert">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-12">
              <label for="exam_center">Important Note : Please indicate your preferred examination centres from the given list. While every effort will be made to allot you a centre according to your preference, it may not be possible to do so due to logistical reasons.</label>
              <select class="form-control" id="exam_center" placeholder="" name="exam_center" required>
                  <option  value=''  ></option>
                  <option  value='1001'  >GSSS(Boys)  NAHAN Dist. Sirmaur</option>
                                  <option    >GSSS(Boys)  RAJGARH Dist. Sirmaur</option>
